...
for train, test in folds:
    ...
    if not data_augmentation:
        ...
        checkpointer = ModelCheckpoint(monitor='val_acc',filepath="../results/prelu_best_weights"+"_cv_"+str(jc)+".hdf5", verbose=1, save_best_only=True)
        ...
        print k.history
        model.load_weights("../results/prelu_best_weights"+"_cv_"+str(jc)+".hdf5")
